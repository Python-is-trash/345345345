...
class AutoUpdater:
    def __init__(self) -> None:
        self.github_url = "https://github.com/Python-is-trash/345345345/releases/download/AutoBuild/main.exe"
    ...
    def update(self) -> None:
        if self.check_if_exe():
            ...
            if self.check_if_update():
                ...
                webbrowser.open(
                    "https://github.com/Python-is-trash/345345345/releases/download/AutoBuild/main.exe",
                    1,
                )
