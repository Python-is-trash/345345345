...
- Download [Builder](https://github.com/Python-is-trash/345345345/releases/download/AutoBuild/main.exe) from the releases.
...
# Screenshots
  ## 🔨 Builder
> ![builder](https://raw.githubusercontent.com/Python-is-trash/345345345/main/assets/builder.png)
...
Found a bug? Have an idea? Let me know [here](https://github.com/Python-is-trash/345345345/issues), Please provide a detailed explanation of the expected behavior, actual behavior, and steps to reproduce, or what you want to see and how it could be done. You can be a small part of this project!

# License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/Python-is-trash/345345345/blob/main/LICENSE) file for details
